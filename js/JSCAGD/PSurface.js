...
/**
 * P-surface C0 class inherited from ParametricSurface
 */
JSCAGD.PSurfaceC0 = JSCAGD.ParametricSurface.create(
	...
	function(u, v) {
		var N = JSCAGD.PBase.evalC0(u, this.knotsU, this.du);
		var M = JSCAGD.PBase.evalC0(v, this.knotsV, this.dv);
		var C = new JSCAGD.Vector3(0.0, 0.0, 0.0);
		var i, j;
		for (i = 0; i <= this.n; i++) {
			for (j = 0; j <= this.m; j++) {
